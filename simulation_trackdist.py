...
with open("Data/K1dist.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerows(data1)

with open("Data/K2dist.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerows(data2)

with open("Data/I1dist.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerows(datai1)

with open("Data/I2dist.csv", "w", newline="") as f:
    writer = csv.writer(f)
